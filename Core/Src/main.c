...
#define nRF24L01_SYSMIC_CHANNEL 0x60
#define TX_ONLY         0x01
/* USER CODE END PD */
...
int main(void)
{
  ...
  MX_USART1_UART_Init();
  /* USER CODE BEGIN 2 */
  memset(rx_node_addr, 0xE7, 5); // TEST 03/2024
  ...
  //nRF24_SetRFChannel(&tx_device, nRF24L01_SYSMIC_CHANNEL); // TEST 03/2024
...
#ifndef TX_ONLY
  nRF24_HW_Init(&rx_device, &hspi1, GPIOB, GPIO_PIN_0, GPIOB, GPIO_PIN_1);
